...
const Pagination = (props) => {
  ...
  return (
    <div className='pagination'>
        <button onClick={onLeftClick} className='pagination__leftIcon'>
            <div>
        ...
        <div className='pagination__numbers'>{page} de {totalPages}</div>

        <button onClick={onRightClick} className='pagination__rightIcon'>
            <div>
